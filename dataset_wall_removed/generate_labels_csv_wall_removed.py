...
def main():
    ...
    # labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_removed\clean\labels_csv" # change this per run
    csv_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_removed\occluded\preprocessed_csv_files" # change this per run
    labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_removed\occluded\labels_csv" # change this per run
