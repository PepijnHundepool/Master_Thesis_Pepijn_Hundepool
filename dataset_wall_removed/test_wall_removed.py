...
from train_wall_removed_NoXYZ import ( # change this per run
    PointCloudDataset,
...
npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\wall_added_and_removed\occluded\npy_files_filtered_no_augmented" # change this per run
labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\wall_added_and_removed\occluded\labels_npy_filtered_no_augmented" # change this per run

# test_files = ["room_test_1_occluded_dt_scan_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
test_files = ["room_1_occluded_dt_scan_wall_added_removed_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
...
model_path = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_removed\mismatch_detection_model_per_point_wall_removed_clean_and_occluded_2_no_augmented_no_xyz.pth" # change this per run
...
for robot_scan, features, labels, filenames in test_loader:
    ...
    with torch.no_grad():
        ...
        save_path = os.path.join(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_removed\clean_and_occluded\predicted_labels", filename) # change this per run
    ...
    if len(mismatch_points) > 0:
        ...
        for label in unique_labels:
            ...
            # vis_objects.append(shape_result["geometry"]) # change to commented out for no bounding box
