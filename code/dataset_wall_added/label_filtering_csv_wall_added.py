...
if __name__ == "__main__":
    ...
    filter_shadow_labels(
        # csv_folder=r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\occluded\preprocessed_csv_files", # change this per run
        # label_folder=r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\occluded\labels_csv" # change this per run
        csv_folder=r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_added\occluded\preprocessed_csv_files", # change this per run
        label_folder=r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_added\occluded\labels_csv_filtered" # change this per run
    )
