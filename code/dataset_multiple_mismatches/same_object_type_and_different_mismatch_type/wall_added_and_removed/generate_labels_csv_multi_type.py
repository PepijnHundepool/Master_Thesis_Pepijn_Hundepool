...
def main():
    csv_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\wall_added_and_removed\clean\preprocessed_csv_files"  # update as needed
    labels_folder_added = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\wall_added_and_removed\clean\labels_csv"
    labels_folder_removed = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\wall_added_and_removed\clean\labels_csv"
