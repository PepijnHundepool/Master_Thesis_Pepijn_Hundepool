...
from train_pillars_added_NoXYZ import ( # change this per run
    PointCloudDataset,
...
npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_added\occluded\npy_files_filtered_no_augmented" # change this per run
labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_added\occluded\labels_npy_filtered_no_augmented" # change this per run
...
test_files = ["room_1_occluded_robot_scan_pillars_added_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
