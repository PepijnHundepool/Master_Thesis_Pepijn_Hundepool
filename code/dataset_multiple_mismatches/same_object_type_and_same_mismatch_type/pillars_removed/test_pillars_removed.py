...
from train_pillars_removed_NoXYZ import ( # change this per run
    PointCloudDataset,
...
npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_removed\occluded\npy_files_filtered_no_augmented" # change this per run
labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_removed\occluded\labels_npy_filtered_no_augmented" # change this per run
...
test_files = ["room_1_occluded_dt_scan_pillars_removed_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
