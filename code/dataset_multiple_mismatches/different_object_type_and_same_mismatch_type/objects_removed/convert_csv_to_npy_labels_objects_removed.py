...
csv_folder = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\different_object_type_and_same_mismatch_type\objects_removed\occluded\labels_csv_filtered")
npy_folder_xyz = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\different_object_type_and_same_mismatch_type\objects_removed\occluded\npy_files_filtered_no_augmented") # change this per run
npy_folder_labels = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\different_object_type_and_same_mismatch_type\objects_removed\occluded\labels_npy_filtered_no_augmented") # change this per run
