...
csv_folder = Path(r"D:\GitHub\Master_Thesis_Pepijn_Hundepool\datasets\dataset_pillar_removed\clean\labels_csv_filtered")

npy_folder_xyz = Path(r"D:\GitHub\Master_Thesis_Pepijn_Hundepool\datasets\dataset_pillar_removed\clean\npy_files_filtered_no_augmented")
npy_folder_labels = Path(r"D:\GitHub\Master_Thesis_Pepijn_Hundepool\datasets\dataset_pillar_removed\clean\labels_npy_filtered_no_augmented")
