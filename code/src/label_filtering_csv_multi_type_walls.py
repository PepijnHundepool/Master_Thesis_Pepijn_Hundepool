...
if __name__ == "__main__":
    ...
    dt_output_folder = r"D:\GitHub\Master_Thesis_Pepijn_Hundepool\datasets\dataset_multiple_mismatches\different_object_type_and_different_mismatch_type\objects_added_and_removed\occluded\labels_csv_filtered_wall\room_1_occluded_dt_scan_chaos_frames_17_to_17_object_filtered_preprocessed_labels.csv"
    ...
    robot_output_folder = r"D:\GitHub\Master_Thesis_Pepijn_Hundepool\datasets\dataset_multiple_mismatches\different_object_type_and_different_mismatch_type\objects_added_and_removed\occluded\labels_csv_filtered_wall\room_1_occluded_robot_scan_chaos_frames_17_to_17_object_filtered_preprocessed_labels.csv"
    ...
    # filter_labels_pca_clustering(robot_label_file, robot_output_folder, min_cluster_size=10, min_height=2.0, max_neighbor_distance=0.35, min_category_purity=0.99, verticality_thresh=0.8,  min_pca_ratio=10.0)
