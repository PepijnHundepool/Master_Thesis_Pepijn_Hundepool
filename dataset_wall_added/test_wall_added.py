...
from train_wall_added_NoXYZ import ( # change this per run
    PointCloudDataset,
...
npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_added\occluded\npy_files_filtered_no_augmented" # change this per run
labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_added\occluded\labels_npy_filtered_no_augmented" # change this per run

# test_files = ["room_test_1_occluded_robot_scan_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
test_files = ["room_test_1_occluded_robot_scan_wall_added_frames_1_to_1_object_filtered_preprocessed.npy"] # change this per run
...
model_path = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\mismatch_detection_model_per_point_wall_added_clean_and_occluded_1_no_augmented_no_xyz.pth" # change this per run
...
for robot_scan, features, labels, filenames in test_loader:
    ...
    with torch.no_grad():
        ...
        save_path = os.path.join(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\clean_and_occluded\predicted_labels", filename) # change this per run
    ...
    if len(mismatch_points) > 0:
        ...
        for label in unique_labels:
            ...
            # vis_objects.append(shape_result["geometry"]) # change this to commented to exclude bounding box
