...
def main():
    # csv_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\clean\preprocessed_csv_files" # change this per run
    # labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_wall_added\clean\labels_csv" # change this per run
    ...
    labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\wall_added\occluded\labels_csv" # change this per run
