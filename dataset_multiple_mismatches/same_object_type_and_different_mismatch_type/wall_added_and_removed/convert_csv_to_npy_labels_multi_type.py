...
csv_folder = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\pillar_added_and_removed\occluded\labels_csv_filtered")

npy_folder_xyz = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\pillar_added_and_removed\occluded\npy_files_filtered_no_augmented")
npy_folder_labels = Path(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\pillar_added_and_removed\occluded\labels_npy_filtered_no_augmented")
