...
from train_objects_removed_NoXYZ import ( # change this per run
    PointCloudDataset,
...
# npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\pillar_removed\occluded\npy_files_filtered"
# labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_real_world\pillar_removed\occluded\labels_npy_filtered"

npy_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\pillar_added_and_removed\clean\npy_files_filtered_no_augmented" # change this per run
labels_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_different_mismatch_type\pillar_added_and_removed\clean\labels_npy_filtered_no_augmented" # change this per run

# test_files = ["room_test_2_occluded_dt_scan_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run

# test_files = ["room_test_1_occluded_dt_scan_pillar_removed_frames_1_to_1_object_filtered_preprocessed.npy"] # change this per run

test_files = ["room_1_clean_dt_scan_pillar_added_removed_frames_17_to_17_object_filtered_preprocessed.npy"] # change this per run
...
model_path = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_pillar_removed\mismatch_detection_model_per_point_pillar_removed_clean_and_occluded_3_no_augmented_no_xyz.pth" # change this per run
...
for robot_scan, features, labels, filenames in test_loader:
    ...
    with torch.no_grad():
        ...
        save_path = os.path.join(r"D:\Graduation Project\Pointclouds\total\datasets\dataset_pillar_removed\clean_and_occluded\predicted_labels", filename) # change this per run
    ...
    if len(mismatch_points) > 0:
        ...
        for label in unique_labels:
            ...
            # vis_objects.append(shape_result["geometry"]) # change to comment out for no bounding box
