...
if __name__ == "__main__":
    ...
    geometry_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_removed\occluded\labels_csv"
    output_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\pillars_removed\occluded\labels_csv_filtered"
    
    filter_labels_pca_clustering(geometry_folder, output_folder,
                                 k_neighbors=50,
                                 verticality_thresh=0.99,
                                 max_neighbor_distance=0.175,
                                 min_cluster_size=50,
                                 min_height=2.4)
