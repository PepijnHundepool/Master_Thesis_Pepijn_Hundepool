...
if __name__ == "__main__":
    ...
    filter_shadow_labels(
        ...
        csv_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\walls_added\clean\labels",
        label_folder = r"D:\Graduation Project\Pointclouds\total\datasets\dataset_multiple_mismatches\same_object_type_and_same_mismatch_type\walls_added\clean\labels_csv_filtered"
    )
